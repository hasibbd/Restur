...
@extends('admin.admin')
@section('content')
    <input type="text" id="pageno" value="all-table" hidden>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <button type="button" class="btn btn-info" id="modalshow">Add New Table
                                    </button>
                                </div>
                            </div>
                            <!-- /.card-header -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><span id="modal-title">Add New</span>  Table</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tbl_name">Name</label>
                                    <input class="form-control" type="text" id="tbl_name" name="tbl_name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="tbl_capacity">Name Capacity</label>
                                        <input class="form-control" type="text" id="tbl_capacity" name="tbl_capacity">
                                    </div>
                                </div>
                            </div>
                        </div>
