...
@extends('admin.admin')
@section('content')
    <input type="text" id="pageno" value="supply" hidden>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <button type="button" class="btn btn-info" id="modalshow">Add New Supplier
                                    </button>
                                </div>
                            </div>
                            <!-- /.card-header -->
                                        ...
                                        <table class="table table-striped table-bordered table-responsive-sm example" style="width:100%">
                                            ...
                                            @foreach($splr as $t)
                                                <tr>
                                                    <td>{{$s++}}</td>
                                                    <td>{{$t->splr_name}}</td>
                                                    <td>{{$t->splr_phone}} <br>{{$t->splr_email}}<br>{{$t->splr_address}}</td>
                                                    <td>Status

                                                        @switch($t->splr_status)
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><span id="modal-title">Add New</span>  supplier</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="splr_name">Name</label>
                                    <input class="form-control" type="text" id="splr_name" name="splr_name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="splr_phone">Phone</label>
                                        <input class="form-control" type="text" id="splr_phone" name="splr_phone">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="splr_email">Email</label>
                                    <input class="form-control" type="text" id="splr_email" name="splr_email">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="1" placeholder="Enter ..." id="splr_address" name="splr_address"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
