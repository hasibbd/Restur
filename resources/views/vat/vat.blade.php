...
@extends('admin.admin')
@section('content')
    <input type="text" id="pageno" value="vat" hidden>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">All Vat</h3>
                                <div class="text-right">
                                    <button type="button" class="btn btn-info" id="modalshow">Add New Vat
                                    </button>
                                </div>
                            </div>
                            <!-- /.card-header -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><span id="modal-title">Add New</span> Vat</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="vat_name" name="vat_name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="vat_price">Vat Percent</label>
                                    <input class="form-control" type="text" id="vat_price" name="vat_price">
                                </div>
                            </div>
                        </div>
                    </div>
